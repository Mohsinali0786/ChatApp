...
import { collection, getDocs, where, query , setDoc, getDoc ,doc ,serverTimestamp , updateDoc } from "firebase/firestore"
    ...
    const handleSelect = async () => {
        ...
        try {
            ...
            if (!res.exists()) {
                ...
                await updateDoc(doc(db, "userChates", currentUser.uid), {
                    [combinedId + ".userInfo"]: {
                      uid: user.uid,
                  ...
                  await updateDoc(doc(db, "userChates", user.uid), {
                    [combinedId + ".userInfo"]: {
                      uid: currentUser.uid,
